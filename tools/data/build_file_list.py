...
from tools.data.parse_file_list import (parse_directory, parse_diving48_splits,
                                        ...
                                        parse_ucf101_splits, parse_baseball_splits)
...
def main():
    ...
    elif args.dataset == 'baseball':
        splits = parse_baseball_splits()
    else:
        raise ValueError(
            f"Supported datasets are 'ucf101, sthv1, sthv2', 'jester', "
            f"'mmit', 'mit', 'kinetics400', 'kinetics600', 'kinetics700', 'baseball', but "
            f'got {args.dataset}')
